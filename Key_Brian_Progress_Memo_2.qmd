...
-   Remove country-years that appear in HR Scores but are systematically absent in V-Dem---cases shown in @tbl-vdem-miss, below:
...
For the creation of the respective tuning grids, the first four use `levels = 10`, whereas the latter two use `levels = 5`.
