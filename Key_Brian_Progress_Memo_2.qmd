...
This final step is important. Year can be used as an imputation predictor for future V-Dem observations, as the dataset will almost certainly continue to be produced;^[The 2024 V-Dem Dataset is scheduled to be released on 07 March 2024.] yet it cannot be used to predict HR Scores, for that variable ends in 2019.^[Put differently, there is no way to estimate baseline levels of HR Scores for "2023," "2024," etc., when there exists wholesale missingness of said variable for those years.]
...
At this stage, I feel as though my final project is more or less complete.
