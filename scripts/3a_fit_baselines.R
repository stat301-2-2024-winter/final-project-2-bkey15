...
load(here("data/recipes/base_rec_imp_5.rda"))
load(here("data/recipes/base_rec_imp_10.rda"))
load(here("data/recipes/base_rec_imp_20.rda"))
...
wfl_set <- workflow_set(
  preproc = list(
    neighbors_5 = base_rec_imp_5,
    neighbors_10 = base_rec_imp_10,
    neighbors_20 = base_rec_imp_20
    ),
  models = list(
    null = null_spec,
    lm = basic_spec
