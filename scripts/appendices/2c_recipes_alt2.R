...
#### complete check ----
##### 5 neighbors ----
rec_check <- basic_rec_5_alt2 |> 
  prep() |> 
  bake(new_data = NULL)

##### 10 neighbors ----
rec_check <- basic_rec_10_alt2 |> 
  prep() |> 
  bake(new_data = NULL)

##### 20 neighbors ----
rec_check <- basic_rec_20_alt2 |> 
  prep() |> 
  bake(new_data = NULL)
...
basic_rec_5_alt2 |> 
  save(
    file = here("data/recipes/appendices/basic_rec_5_alt2.rda")
  )

basic_rec_10_alt2 |> 
  save(
    file = here("data/recipes/appendices/basic_rec_10_alt2.rda")
  )

basic_rec_20_alt2 |> 
  save(
    file = here("data/recipes/appendices/basic_rec_20_alt2.rda")
  )
